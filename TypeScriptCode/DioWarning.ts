...
if(!('CanRunAd' in window)){
    const DIVcomments:      HTMLElement = document.querySelector('.comments');
    const DIVcomment:       HTMLElement = document.createElement('div');
    const DIVreferenceNode: HTMLElement = document.querySelector('.comment:first-child');
    ...
    const DIVbannerWarning:  HTMLElement = document.createElement('div');
    const DIVvideocontainer: HTMLElement = document.querySelector('.video-container');
    const DIVreferenceNode2: HTMLElement = document.querySelector('.main-video');
